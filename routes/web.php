...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/mayor-message', [SettingController::class, 'editMayorMessage'])->name('mayor_message.edit');
    Route::put('/mayor-message', [SettingController::class, 'updateMayorMessage'])->name('mayor_message.update');
...
Route::get('coummuniqué/{slug}', [HomeController::class, 'postShow'])->name('post_show');
Route::get('evenement/{id}', [HomeController::class, 'eventShow'])->name('event_show'); //mettre a jour pour utiliser le slug a la place de l'ID
