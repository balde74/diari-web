                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="ts-service-box">
                        ...
                        <div >
                            ...
                            <div >
                                <h3 class="service-box-title"><a href="{{ route('event_show',$event->id) }}">{{ Str::limit($event->title,50,'...') }}</a></h3>
                            ...
                            <a class="learn-more d-inline-block" href="{{ route('event_show',$event->id) }}" aria-label="service-details"><i class="fa fa-caret-right"></i> Voir plus</a>
                            </div>
                        </div>
                    </div><!-- Service1 end -->
                </div><!-- Col 1 end -->
