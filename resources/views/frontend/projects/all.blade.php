            ...
            @foreach ($projects as $project)
                ...
                <div class="ts-service-box">
                    ...
                    <div class="d-flex">
                        ...
                        <div >
                            <h3 class="service-box-title"><a href="{{ route('project_show',$project->slug) }}">{{ Str::limit($project->title,50,'...') }}</a></h3>
                            ...
                            <a class="learn-more d-inline-block" href="{{ route('project_show',$project->slug) }}" aria-label="service-details"><i class="fa fa-caret-right"></i> Voir plus</a>
                        </div>
                    </div>
                </div><!-- Service1 end -->
                </div><!-- Col 1 end -->
