                ...
                <div class="col-lg-9 mb-5 mb-lg-0">
                    ...
                    <div class="post-content post-single">
                        <div class="post-media post-image">
                            @if ($post->image)
                                <img loading="lazy" class="w-100 img-fluid" src="{{ asset('documents/' . $post->image) }}"
                        ...
                        <div class="post-body">
                            <div class="entry-header">
                                <div class="post-meta">
                                    <span class="post-author">
                                        <i class="far fa-user"></i><a href="#"> {{ $post->user->getFullname() }}</a>
                                    </span>
                                    <span class="post-cat">
                                        <i class="far fa-folder-open"></i><a href="#"> Communiqué</a>
                                    </span>
                                    <span class="post-meta-date"><i class="far fa-calendar"></i> {{ $post->created_at->format('d/m/Y') }}</span>
                            ...
                            <div class="entry-content">
                                ...
                                @foreach ($post->sections->sortBy('position') as $section)
                                    @if ($section->image)
                                        <img src="{{ asset('documents/' . $section->image) }}" class="img-fluid no-border"
                                            alt="image de la section" width="100%">
                                        <br /><br />
                                    @endif
