    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('partner.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 ">
                                <input type="text" name="name" id="name" required class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" autofocus autocomplete="off">
                                @if ($errors->has('name'))
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 ">
                                <input type="text" name="acronym" id="acronym"
                                    ...
                                    value="{{ old('acronym') }}" autocomplete="off">
