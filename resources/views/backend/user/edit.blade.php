                    ...
                    <form data-parsley-validate class="form-horizontal form-label-left" method="POST"
                        ...
                        @if (Auth::user()->role_id == 1)
                            ...
                            <div class="form-group item" id="district-group">
                                <label class="control-label col-md-3 col-sm-3 label-align ">Selectionner le district
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <select id="district_id"
                                        ...
                                        @foreach ($districts as $district)
                                            <option value="{{ $district->id }}"
                                                @if ($district->id == $user->district_id) selected @endif> {{ $district->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        @if (Auth::user()->role_id == 1 && $user->id != Auth::user()->id)
                            ...
                            <div class="item form-group">
                                <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Confirmer le
                                    mot de passe</label>
                                <div class="col-md-6 col-sm-6 ">
