...
<div class="col-md-12 col-sm-12 ">
	<div class="x_panel">
		...
		<div class="x_content">
			<br />
			<form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('staff.store') }}" enctype="multipart/form-data">
				...
				<div class="item form-group">
					...
					<input type="text" name="name" id="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}"  autocomplete="off">
					@if ($errors->has('name'))
				...
				<div class="item form-group">
					...
					<div class="col-md-9 col-sm-8 ">
					<input type="text" name="position" id="position" class="form-control {{ $errors->has('position') ? ' is-invalid' : '' }}" value="{{ old('position') }}" autocomplete="on">
				...
				<div class="item form-group">
					...
					<div class="col-md-9 col-sm-8 ">
					<input type="text" name="department" id="department" class="form-control {{ $errors->has('department') ? ' is-invalid' : '' }}" value="{{ old('department') }}" autocomplete="on">
				...
				<div class="item form-group">
                    ...
                    <div class="col-md-9 col-sm-8 ">
                            <input type="month" name="start_date" id="start_date" required="required" class="form-control {{ $errors->has('start_date') ? ' is-invalid' : '' }}" value="{{ old('start_date') }}">
