        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-2">
                        @if ($post->image)
                            <img src="{{ asset('documents/' . $post->image) }}" alt="image de presentation" width="100%">
                        @endif
                    </div>
                    <form data-parsley-validate class="form-horizontal form-label-left col-md-10" method="POST"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 ">
                                <textarea name="introduction" required="required"
                                    class="form-control summernote {{ $errors->has('introduction') ? ' is-invalid' : '' }}" cols="30"
                                    rows="5">{{ old('introduction') ?? $post->introduction }}</textarea>
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Image de
                                l'article</label>
                            <div class="col-md-8 col-sm-8 ">
                                <div class="custom-file">
                                    <input type="file" name="image"
                                        class="custom-file-input {{ $errors->has('image') ? ' is-invalid' : '' }}"
                                        id="validatedCustomFile" value="{{ old('image') }}??$post->image">
                                    ...
                                    <select id=""
                                        ...
                                        @foreach ($districts as $district)
                                            <option value="{{ $district->id }}"
                                                @if ($district->id == $post->district_id) selected @endif>{{ $district->name }}
                                            </option>
                                        @endforeach
                                    </select>
