        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
                    ...
                    <ul class="list-arrow">
                        @foreach ($pages->where('parent_zone', 'services') as $presentationPage)
                            <li><a
                                    href="{{ route('page_show', $presentationPage->slug) }}">{{ $presentationPage->title }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div><!-- Col end -->
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
                    <h3 class="widget-title">Districts</h3>
                    <ul class="list-arrow">
